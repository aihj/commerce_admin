...
const AppRegisterView = () => {
  ...
  const handleUpdateStatus = async (newStatus: string) => {
    ...
    try {
      await updateStatus(parsedIdx!, newStatus);
      ...
      <Box sx={{ display: 'flex', gap: 4, alignItems: 'flex-start' }}>
          ...
          <Table sx={{ width: '100%', border: '1px solid #e0e0e0' }}>
            <TableBody>
              <TableRow>
                ...
                <TableCell>0000.00.00 00:00</TableCell>
              </TableRow>
              <TableRow>
        ...
        >
            ...
            <Button
              ...
              color="primary"
              onClick={() => {
                if (status === '환불_완료' || status === '주문_취소' || status === '배송_완료') {
                  alert('이미 환불 완료, 주문 취소, 또는 배송 완료된 주문은 배송완료 처리를 할 수 없습니다.');
                  return;
                }
