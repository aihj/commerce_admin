  ...
  ({ children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={`tiptap-toolbar flex-col p-[16px] w-fit border-r border-solid border-slate-200`}
        {...props}
      >
        {children}
      </div>
  ...
  ({ children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        role="group"
        className={`tiptap-toolbar-group flex bg-slate-50 gap-8 p-8
        h-fit`}
        {...props}
        // grid grid-cols-2 gap-x-[4px] gap-y-[8px]
      >
        {children}
      </div>
    );
